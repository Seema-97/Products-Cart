...
const Header = () => {
  ...
  const [receivedCartData, setReceivedCartData] = useState(null);
      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div className="d-flex " style={{ marginRight: "200px" }}>
            ...
            {isProductSaved ? (
              //   <button className="btn btn-outline-success" type="submit" onClick={handleProductBuy}>
              //     Buy   </button>
              <button
                type="button"
             ...
             <Modal receivedCartData = {receivedCartData}/>
